	...
	public function up()
	{
		...
		// Paradas
			$this->forge->addField([
				...
				'Fec Ini' => [ 'type'=> 'datetime','comment' => 'Fecha Inicio',],
				'Fec Fin' => [ 'type'=> 'datetime','comment' => 'Fecha Fin',],
				'FecCre timestamp default now()',
		...
		// Registro Evaluación
			$this->forge->addField([
				...
				'HabPruResTieReg' => [ 'type'=> 'INT', 'constraint'=> 1,'default'=> 0,'comment' => 'Habilitado Pruebas de Resistencia de Aislamiento a Tierra',],
					'MegMegaReg' => [ 'type'=> 'INT', 'constraint'=> 11,'null'=> true,'comment' => 'Megómetro Megabras nombre',],
					'MegSerieReg' => [ 'type'=> 'INT', 'constraint'=> 11,'null'=> true,'comment' => 'Número de Serie Megómetro',],
					'MegTpruReg' => [ 'type'=> 'INT', 'constraint'=> 11,'null'=> true,'comment' => 'Tensión de Pruebas',],
					'MegTambReg' => [ 'type'=> 'INT', 'constraint'=> 11,'null'=> true,'comment' => 'Temperatura Ambiente',],
					'MegTiPruReg' => [ 'type'=> 'INT', 'constraint'=> 11,'null'=> true,'comment' => 'Tiempo de Prueba',],
